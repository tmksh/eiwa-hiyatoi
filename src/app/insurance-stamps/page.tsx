...
const TAB_META: Record<Tab, { icon: React.ElementType; description: string; color: string; iconBg: string }> = {
  "印紙管理": { icon: Stamp,         description: "印紙方式/現金納付の管理",  color: "text-blue-600",    iconBg: "bg-blue-50" },
  "受払簿":   { icon: ArrowRightLeft, description: "印紙の受払記録",           color: "text-violet-600",  iconBg: "bg-violet-50" },
  "現金納付": { icon: Banknote,       description: "現金での社保納付管理",     color: "text-emerald-600", iconBg: "bg-emerald-50" },
  "徴収台帳": { icon: ClipboardList,  description: "社保・住民税の徴収記録",  color: "text-amber-600",   iconBg: "bg-amber-50" },
  "源泉税":   { icon: Calculator,     description: "源泉所得税の計算・管理",  color: "text-rose-600",    iconBg: "bg-rose-50" },
  "住民税":   { icon: Landmark,       description: "住民税の特別徴収管理",    color: "text-indigo-600",  iconBg: "bg-indigo-50" },
};
